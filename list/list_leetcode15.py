...
Example
Input: a = [1, 2, 3, 21, n = 4
Output: 2 3
Explanation:
a[ 2 ] = 3 is greater than a[ 3 ]. Hence it is a Superior
Element.
a[ 3 ] = 2 is the last element. Hence it is a Superior
Element.
...
obj = Solution()
print(obj.superiorElements([3, 7, 4, 9, 5, 2, 8, 10, 6, 1]))